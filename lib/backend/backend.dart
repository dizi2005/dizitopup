...
import 'schema/enregistred_game_record.dart';
...
export 'schema/enregistred_game_record.dart';
...
/// Functions to query EnregistredGameRecords (as a Stream and as a Future).
Future<int> queryEnregistredGameRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EnregistredGameRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EnregistredGameRecord>> queryEnregistredGameRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      EnregistredGameRecord.collection,
      EnregistredGameRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EnregistredGameRecord>> queryEnregistredGameRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryBannerImageRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<BannerImageRecord>> queryBannerImageRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      BannerImageRecord.collection,
      BannerImageRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );
