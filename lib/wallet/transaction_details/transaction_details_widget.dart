...
class TransactionDetailsWidget extends StatefulWidget {
  const TransactionDetailsWidget({
    super.key,
    required this.transacitonRefs,
    required this.isConfirm,
    required this.isDelivery,
  });

  final DocumentReference? transacitonRefs;
...
class _TransactionDetailsWidgetState extends State<TransactionDetailsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.isConfirm = widget!.isConfirm!;
      _model.isDelivery = widget!.isDelivery!;
      safeSetState(() {});
    });
            ...
            children: [
              Padding(
                ...
                child: StreamBuilder<TransactionRecord>(
                  stream:
                      TransactionRecord.getDocument(widget!.transacitonRefs!),
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      containerTransactionRecord.transactionId,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily:
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      containerTransactionRecord.paymentMethode,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily:
                                ...
                                if (containerTransactionRecord.type == 'BY')
                                  Row(
                                    mainAxisSize: MainAxisSize.max,
                                    mainAxisAlignment:
                                        MainAxisAlignment.spaceBetween,
