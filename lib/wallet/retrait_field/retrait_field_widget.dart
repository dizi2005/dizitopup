...
import 'retrait_field_model.dart';
export 'retrait_field_model.dart';

class RetraitFieldWidget extends StatefulWidget {
  const RetraitFieldWidget({
    super.key,
    required this.type,
  ...
  @override
  State<RetraitFieldWidget> createState() => _RetraitFieldWidgetState();
}

class _RetraitFieldWidgetState extends State<RetraitFieldWidget> {
  late RetraitFieldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RetraitFieldModel());
    ...
    _model.textFieldMask3 = MaskTextInputFormatter(mask: '+509 ## ## ####');
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            'Nom complet (identique à votre compte)',
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily:
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            'Numéro de téléphone du compte ${widget!.paymentMethod}',
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily:
                                      ...
                                      if (_model.optionManual) {
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return WebViewAware(
                                                  child: AlertDialog(
                                                    title:
                                                        Text('Retrait minimum'),
                                                    content: Text(
                                                        'Le montant minimum de retrait est de 200 gourdes.'),
                                                    actions: [
                                                      TextButton(
                                                        onPressed: () =>
                                                            Navigator.pop(
                                        ...
                                        await launchURL(
                                            functions.generateWhatsAppLink(
                                                widget!.type == 'DP'
                                                    ? 'Dépôt'
                                                    : 'Retrait--Nom: ${_model.textController2.text}, Numéro : ${_model.textController3.text}',
                                                double.parse(_model
                                                  ...
                                                  builder:
                                                    ...
                                                    return WebViewAware(
                                                      child: AlertDialog(
                                                        ...
                                                        content: Text(
                                                            'Êtes vous sur de vouloir faire un ${widget!.type == 'DP' ? 'Dépôt' : 'Retrait'} de ${_model.textController1.text}'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
